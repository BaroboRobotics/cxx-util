...
struct associated_logger<op_continuation<Task, Results...>, L> {
    ...
    using type = associated_logger_t<typename op_continuation<Task, Results...>::task_type::handler_type, L>;
...
template <class Task, class... Results, class L>
struct associated_logger<op_continuation<Task, Results...>, L,
        void_t<typename op_continuation<Task, Results...>::task_type::logger_type>> {
    // Specialization to allow tasks wrapped in op continuations to manually specify their
    // associated loggers.

    using type = typename op_continuation<Task, Results...>::task_type::logger_type;
