...
int main (int argc, char**argv) try {
    ...
    auto intelHex = util::intelhex::Grammar<decltype(b)>{};
    auto data = std::list<util::intelhex::DataRecord>{};
    auto startTime = std::chrono::steady_clock::now();
    auto result = util::intelhex::qi::parse(b, e, intelHex >> util::intelhex::qi::eoi, data);
